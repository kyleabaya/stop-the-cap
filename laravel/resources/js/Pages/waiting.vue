<template>
    <div
        class="flex h-screen flex-col items-center justify-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"
    >
        ...
        <div class="flex-5 flex items-center">
            <div
                ...
                :key="player.id"
                class="animate-bounce rounded-lg bg-white p-4 pl-5 text-lg font-semibold text-gray-800 shadow-lg"
            >
                {{ player.name }}
            </div>
        </div>
